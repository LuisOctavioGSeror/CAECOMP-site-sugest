    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light navbarrr sticky-top">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                ...
                <ul class="col-md-5 nav navbar-nav mr-auto nav-fill d-flex">
                    <li class="nav-item">
                        <a class="nav-link" href="#O_que_fazemos"><h4 id="nossosservicos" data-toggle="collapse" data-target=".navbar-collapse.show">Minha conta</h4></a>
                    </li>    
                    <li class="nav-item">
        ...
        <div class="container-fluid">
            <div class="row">
                        <div class=" offset-md-1 col-md-5 col-12">
                            <p></p>
                            <p></p>
                            <img src="pessoa15.jfif" class="visibility" alt="...">
                            <h5 style="padding-top: 3%">Nome: Luisa</h5>
                            <h5 style="padding-top: 3%">Curso: Engenharia da Computação</h5>
                            <h5 style="padding-top: 3%">Semestre: setimo</h5>
                            <h5 style="padding-top: 3%">E-mail: email@outlook.com</h5>
                            <h5 style="padding-top: 3%">RGA: 201621901021</h5>

                        </div>
                    <div class="col-md-6 col-12"  style="padding-top: 3%; margin-bottom: 7%;">
                        <h3 style="padding-bottom: 6%;">Entre em ontato com o CA por aqui</h4>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <button type="button" class="btn btn-dark" style="margin-left: 45%; margin-top: 5%; color: #F5C734;">Enviar</button>
                ...
                <div class="row">
                    <h1 style="padding-left: 33%; padding-up: 5%; padding-bottom: 1%;">Eventos cadastrados</h1>
                        <div class="container">
